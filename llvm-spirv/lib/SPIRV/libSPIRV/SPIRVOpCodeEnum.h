...
_SPIRV_OP(ConvertUToImageNV, 5391)
_SPIRV_OP(ConvertUToSamplerNV, 5392)
_SPIRV_OP(ConvertImageToUNV, 5393)
_SPIRV_OP(ConvertSamplerToUNV, 5394)
_SPIRV_OP(ConvertUToSampledImageNV, 5395)
_SPIRV_OP(ConvertSampledImageToUNV, 5396)
_SPIRV_OP(SamplerImageAddressingModeNV, 5397)
