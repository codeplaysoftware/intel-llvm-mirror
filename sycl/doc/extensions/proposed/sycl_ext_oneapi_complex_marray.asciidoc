...
The merge free function is added to construct complex marrrays from real and
...
However, it does maintain the `marray` interface. The real and merge functions
are necessary for a complete interface.
...
namespace oneapi {
  ...
  marray<sycl::ext::oneapi::complex<T> merge(marray<T, NumElements> real, marray<T, NumElements> imag);

  template <class T, std::size_t NumElements>
  marray<sycl::ext::oneapi::complex<T> merge(marray<T, NumElements> real, T imag);

  template <class T, std::size_t NumElements>
  marray<sycl::ext::oneapi::complex<T> merge(T real, marray<T, NumElements> imag);
  ...
  template <class T, std::size_t NumElements>
  marray<T> get_real(marray<sycl::ext::oneapi::complex<T>, NumElements> input, std::size_t index);

  template <class T, std::size_t NumElements>
  marray<T> get_imag(marray<sycl::ext::oneapi::complex<T>, NumElements> input, std::size_t index);
...
The functions should execute the math operation elementwise across the
