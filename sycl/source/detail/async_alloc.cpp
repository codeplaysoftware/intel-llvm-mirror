...
// __SYCL_EXPORT
// memory_pool::memory_pool(const sycl::context &ctx,
...
//           ext::oneapi::experimental::initial_threshold_key>())
//           {
//     std::cout << "yeash" << std::endl;
//     // ext::oneapi::experimental::initial_threshold
//     InitialThresholdProp
//     =
//     //     props.template get_property<
//     //
//     ext::oneapi::experimental::initial_threshold>();
//     // threshold = InitialThresholdProp.value;
//   }

//   if (kind == sycl::usm::alloc::host) {
//     throw sycl::exception(
//         sycl::make_error_code(sycl::errc::invalid),
//         "Host allocated memory pools selected but
//         device supplied!");
//   }
...
//         "Only device allocated memory pools are
//         supported!");
//   }

//   sycl::property_list p;

//   impl =
//   std::make_shared<detail::memory_pool_impl>(ctx,
//   dev, kind, p);
// }
...
void *async_malloc(sycl::handler &h, sycl::usm::alloc kind, size_t size) {
  ...
  if (kind != sycl::usm::alloc::device) {
    throw sycl::exception(
        sycl::make_error_code(sycl::errc::feature_not_supported),
        "Only device backed asynchronous allocations "
        "are supported!");
  }
