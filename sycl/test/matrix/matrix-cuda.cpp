...
constexpr int SUB_TILES_M = 2; // number of submatrices per row of accumulator ("C", "D") matrices.
constexpr int SUB_TILES_N = 1; // number of submatrices per col of accumulator matrices.
