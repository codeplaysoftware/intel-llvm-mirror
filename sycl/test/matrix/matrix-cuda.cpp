...
// forms a matrix from a single "TILE" using cuda example terminology.  Multiple
// TILES can be used to construct yet larger matrices. This example uses
// row_major a, b, and accumulator matrices.
