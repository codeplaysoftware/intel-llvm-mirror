...
int main() {
  ...
  uint64_t device_ptr1 = _V1::ext::oneapi::allocate_image(
      {width, 0, 0}, image_channel_order::rgba, image_channel_type::fp32, ctxt);
  ...
  _V1::ext::oneapi::copy_image(device_ptr1, dataIn1.data(), {width, 0, 0}, 0,
                               ctxt);
  _V1::ext::oneapi::copy_image(device_ptr2, dataIn2.data(), {width, 0, 0}, 0,
                               ctxt);
  ...
  _V1::ext::oneapi::image_handle imgHandle1 = _V1::ext::oneapi::create_image(
      ...
      image_channel_type::fp32, {width, 0, 0}, ctxt);
