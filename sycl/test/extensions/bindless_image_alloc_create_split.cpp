...
int main() {
  ...
  uint64_t device_ptr1 = _V1::ext::oneapi::allocate_image(
      {width, height, 1}, image_channel_order::rgba, image_channel_type::fp32,
      ctxt);
  ...
  _V1::ext::oneapi::copy_image(device_ptr1, dataIn1.data(), {width, height, 1},
                               0, ctxt);
  _V1::ext::oneapi::copy_image(device_ptr2, dataIn2.data(), {width, height, 1},
                               0, ctxt);
  ...
  _V1::ext::oneapi::image_handle imgHandle1 = _V1::ext::oneapi::create_image(
      ...
      image_channel_type::fp32, {width, height, 1}, ctxt);
  ...
  try {
    ...
    q.submit([&](handler &cgh) {
      ...
      cgh.parallel_for<image_addition>(N, [=](id<1> id) {
        float sum = 0;
        float4 px1 =
            _V1::ext::oneapi::read_image<float4>(imgHandle1, int(id[0]));
        float4 px2 =
            _V1::ext::oneapi::read_image<float4>(imgHandle2, int(id[0]));
