...
DECLARE_GROUP_ASYNC_COPY(int8)
DECLARE_GROUP_ASYNC_COPY(int16)
DECLARE_GROUP_ASYNC_COPY(int32)
DECLARE_GROUP_ASYNC_COPY(int64)

DECLARE_GROUP_ASYNC_COPY(uint8)
DECLARE_GROUP_ASYNC_COPY(uint16)
DECLARE_GROUP_ASYNC_COPY(uint32)
DECLARE_GROUP_ASYNC_COPY(uint64)

DECLARE_GROUP_ASYNC_COPY(fp32)

#ifdef cl_khr_fp64
DECLARE_GROUP_ASYNC_COPY(fp64)
#endif

#ifdef cl_khr_fp16
DECLARE_GROUP_ASYNC_COPY(fp16)
#endif

#undef DECLARE_GROUP_ASYNC_COPY
#undef DECLARE_GROUP_ASYNC_COPY_VEC_SIZES
#undef DECLARE_GROUP_ASYNC_COPY_IMPL
