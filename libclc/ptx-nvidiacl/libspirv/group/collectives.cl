...
__local complex_half *
__clc__get_group_scratch_complex_half() __asm("__clc__get_group_scratch_complex_half");
__local complex_float *
__clc__get_group_scratch_complex_float() __asm("__clc__get_group_scratch_complex_float");
__local complex_double *
__clc__get_group_scratch_complex_double() __asm("__clc__get_group_scratch_complex_double");
...
_CLC_DEF _CLC_OVERLOAD _CLC_CONVERGENT complex_half __clc__SubgroupShuffle(complex_half x,
                                                                     uint idx) {
...
_CLC_DEF _CLC_OVERLOAD _CLC_CONVERGENT complex_float __clc__SubgroupShuffle(complex_float x,
                                                                     uint idx) {
...
_CLC_DEF _CLC_OVERLOAD _CLC_CONVERGENT complex_double __clc__SubgroupShuffle(complex_double x,
                                                                     uint idx) {
...
_CLC_DEF _CLC_OVERLOAD _CLC_CONVERGENT complex_half __clc__SubgroupShuffleUp(complex_half x,
                                                                     uint delta) {
  complex_half_converter conv = {x};
...
_CLC_DEF _CLC_OVERLOAD _CLC_CONVERGENT complex_float __clc__SubgroupShuffleUp(complex_float x,
                                                                     uint delta) {
  complex_float_converter conv = {x};
...
_CLC_DEF _CLC_OVERLOAD _CLC_CONVERGENT complex_double __clc__SubgroupShuffleUp(complex_double x,
                                                                     uint delta) {
  complex_double_converter conv = {x};
  conv.i.x = __clc__SubgroupShuffleUp(conv.i.x, delta);
  conv.i.y = __clc__SubgroupShuffleUp(conv.i.y, delta);
...
_CLC_DEF _CLC_OVERLOAD _CLC_CONVERGENT complex_ ## TYPE __clc_complex_mul(complex_ ## TYPE z, \
                                                                          complex_ ## TYPE w) { \
  TYPE a = z.real; \
  TYPE b = z.imag; \
  TYPE c = w.real; \
...
// TODO remove these definitions after we have proper implementation of std::complex multiplication in SYCL
...
__CLC_SUBGROUP_COLLECTIVE(CMulKHR, __CLC_COMPLEX_MUL, complex_half, ((complex_half){1,0}))
__CLC_SUBGROUP_COLLECTIVE(CMulKHR, __CLC_COMPLEX_MUL, complex_float, ((complex_float){1,0}))
__CLC_SUBGROUP_COLLECTIVE(CMulKHR, __CLC_COMPLEX_MUL, complex_double, ((complex_double){1,0}))
...
#define __CLC_GROUP_COLLECTIVE_MANUAL_MANGLE(SPIRV_NAME_MANGLED, CLC_NAME, OP, TYPE, IDENTITY) \
  _CLC_DEF _CLC_CONVERGENT TYPE SPIRV_NAME_MANGLED(uint scope, uint op, TYPE x) {                \
        __CLC_GROUP_COLLECTIVE_INNER(CLC_NAME, OP, TYPE, IDENTITY) \
      } 
...
__CLC_GROUP_COLLECTIVE_MANUAL_MANGLE(_Z20__spirv_GroupCMulKHRjjN5__spv12complex_halfE, CMulKHR, __CLC_COMPLEX_MUL, complex_half, ((complex_half){1,0}))
__CLC_GROUP_COLLECTIVE_MANUAL_MANGLE(_Z20__spirv_GroupCMulKHRjjN5__spv13complex_floatE, CMulKHR, __CLC_COMPLEX_MUL, complex_float, ((complex_float){1,0}))
__CLC_GROUP_COLLECTIVE_MANUAL_MANGLE(_Z20__spirv_GroupCMulKHRjjN5__spv14complex_doubleE, CMulKHR, __CLC_COMPLEX_MUL, complex_double, ((complex_double){1,0}))
