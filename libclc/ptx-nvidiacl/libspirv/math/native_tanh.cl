...
_CLC_DEF _CLC_OVERLOAD double __spirv_ocl_native_tanh(double x) {
  return __nv_tanh(x);
}

_CLC_UNARY_VECTORIZE(_CLC_OVERLOAD _CLC_DEF, double, __spirv_ocl_native_tanh, double)
...
_CLC_UNARY_VECTORIZE(_CLC_OVERLOAD _CLC_DEF, float, __spirv_ocl_native_tanh, float)
